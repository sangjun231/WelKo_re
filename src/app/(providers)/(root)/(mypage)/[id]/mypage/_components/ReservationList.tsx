          ...
          <div key={`${post.id}-${index}`} className="web:mb-[40px] web:pb-[40px] mb-[20px] border-b pb-[20px]">
            <div className="flex justify-between">
              <div>
                ...
                <p
                  className={`web:text-[21px] text-[14px] font-medium ${status === 'Upcoming Tour' ? 'text-primary-300' : status === 'Refunded' ? 'text-error-color' : 'text-grayscale-900'}`}
                >
                  {status}
                </p>
              </div>
            ...
            {status === 'Upcoming Tour' ? (
              <div>
                ...
                <button
                  className="web:p-[16px] web:text-[18px] w-full rounded-lg border p-[8px] text-[14px] font-semibold text-grayscale-700"
