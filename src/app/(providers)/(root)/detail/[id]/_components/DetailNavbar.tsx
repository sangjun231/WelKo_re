        ...
        <div className="border-t-1 mx-auto max-w-[360px] border-grayscale-100 py-4 shadow-custom-navbar">
          <div className="mx-auto flex max-w-[320px] items-center">
            ...
            <button
              ...
              className="w-40 flex-1 rounded-xl bg-primary-300 px-4 py-3 text-base font-semibold text-white"
            >
              Confirm and Pay
            </button>
          </div>
        ...
        <div className="border-t-1 mx-auto max-w-[360px] border-grayscale-100 py-4 shadow-custom-navbar">
          <div className="mx-auto flex max-w-[320px] items-center justify-between">
            ...
            <button
              ...
              className="w-40 rounded-xl bg-primary-300 px-4 py-3 text-base font-semibold text-white"
            >
              Reserve
            </button>
          </div>
